...
- RISC-V Instruction Set Manual, RISC-V "V" Vector Extension (either stable version 0.7.1 or 'master' version, configurable in the model using the 'vector_version' parameter. 'master' version conforms to specification changes up to 8 October 2019 and is regularly updated to track the evolving specification.)
